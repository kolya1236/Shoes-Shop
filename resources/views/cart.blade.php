    ...
    <div class="container-fluid text-center">
        @foreach($items as $id => $value)
            <div class="row cartRow">
                ...
                <a href="{{asset('/cart/decrement')}}/{{$id}}" class="col-md-2 row">
                    <button class="button col-md-12">Drop one</button>
                </a>
                <a href="{{asset('/cart/remove')}}/{{$id}}" class="col-md-2 row">
        ...
        @if($quantity>0)
            <div class="row">
                <a href="{{asset('/cart/buy')}}" class="col-md-2 col-md-offset-5 row" onclick="ThanksForPurchaising()">
